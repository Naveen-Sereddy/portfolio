...
const LineChart = ({
  ...
  }), data.map((d, i) => i % Math.ceil(data.length / 8) === 0 && /*#__PURE__*/React.createElement("text", {
    key: i,
    x: x(i),
    y: H - 8,
    textAnchor: "middle",
    fontSize: "10"
  }, d[xKey]))), /*#__PURE__*/React.createElement("path", {
    d: path,
    fill: "none",
    stroke: color,
    strokeWidth: "2",
...
const BudgetBar = ({
  ...
  }, unit, spent.toFixed(1), "K / ", unit, budget.toFixed(1), "K")), /*#__PURE__*/React.createElement("div", {
