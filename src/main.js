...
(function () {
  ...
  const projects = [
    ...
    },
    {
      ...
      study: {
        problem: "The store leaned hard on social media and foot traffic, but a lot of first-time customers didn't get how the liquidation pricing worked, what categories meant, or how the store even operated.",
        role: "I worked directly with the owner on customer questions, business goals, and the day-to-day operational stuff, while handling UX, UI, front-end development, deployment, and SEO myself.",
        process: [
          "Talked through the business with the owner",
          "Identified the questions customers kept asking",
          "Organized the content architecture",
          "Designed responsive layouts",
          "Built the site with React and Tailwind CSS",
          "Handled SEO and deployment",
        ],
        result: "A central place online that actually explains how the business works, helps customers understand it faster, and gives quick access to store info.",
        credibility: "This wasn't about piling on features. It was about cutting confusion. Most of the design decisions came down to one thing: helping new customers understand liquidation pricing before they ever walk in the door.",
      },
      shots: [
